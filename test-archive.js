/**
 * Manual test script for archive functionality (using compiled JS)
 */

const { StandaloneTodoManager } = require('./out/mcp/standaloneTodoManager');
const { InMemoryStorage } = require('./out/storage/InMemoryStorage');
const { TodoMarkdownFormatter } = require('./out/utils/todoMarkdownFormatter');
